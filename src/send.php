...
$my_email = '3swordsrepublic@gmail.com';
...
if(validateEmail($_POST['email'])){
	...
	$content = "<p>INFORMATION</p>
		<p>You have recieved an email from $name via the website's form book. Here's the message:</p>
		<p>$message</p>
		<p>
			From: $name 
			<br />
	...
	if(!$try){
		...
		echo '<p>Thank you ' . $name . '. We look forward to reading your message.' . $email . ';
	}
